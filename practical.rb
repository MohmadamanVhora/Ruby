class Car
  ...
  def variable_test1
    ...
    testing2 = @color
    # return testing1
    return "Instance Variable Color accessed from different method: #{testing2}"
  end
...
# puts testing_variables.variables
# puts testing_variables.variable_test1
# puts testing_variables.variable_test2
# puts testing_variables.variable_test3             # This Throw an error `variable_test3': undefined local variable or method `color' (NameError)
# puts ""
